...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { data_cadastro: @produto.data_cadastro, data_sincronizacao: @produto.data_sincronizacao, descricao: @produto.descricao } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { data_cadastro: @produto.data_cadastro, data_sincronizacao: @produto.data_sincronizacao, descricao: @produto.descricao } }
